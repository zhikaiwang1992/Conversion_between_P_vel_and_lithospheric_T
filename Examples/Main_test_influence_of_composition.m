%*************************************************************************%
% Script: Main_test_influence_of_composition.m
%
%
...
out  = ['temperature_velocity_olivine95_Orthopyroxene01_A49.txt'];
...
A   = 0.049;  % Unit: dimensionless, from (0.148, Porter et al., 2019; 0.049, Shapiro e al., 2004)
