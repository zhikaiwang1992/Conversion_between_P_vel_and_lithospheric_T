%*************************************************************************%
% Script: Main_test_influence_of_pressure.m
%
%
...
out  = ['temperature_velocity_H80km.txt'];
...
A   = 0.074;  % Unit: dimensionless, from (0.148, Porter et al., 2019; 0.049, Shapiro e al., 2004)
