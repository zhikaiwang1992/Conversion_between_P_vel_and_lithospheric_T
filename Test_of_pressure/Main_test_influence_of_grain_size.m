%*************************************************************************%
% Script: Main_test_influence_of_grain_size.m
%
%
...
out  = ['temperature_velocity_grain_size_1000um.txt'];
...
Perc   = [ 0.75, 0.21 ,0.035, 0, 0.005];   %% oceanic 
...
a   = 0.26;    % Unit: dimensionless, from Porter et al., 2019
H   = 424E3;   % Unit: J/mol, from Porter et al., 2019
V   = 6E-6;    % Unit: m^3/mol, from Porter et al., 2019
d   = 1000e-6;   % Unit: m, from Porter et al., 2019
...
for ii = 1:1:NT
    ...
    [Vsyn(ii)] = Porter_convert_temperature_to_vel(Pref, Tref, Kref, Uref, Dref, Ptarg, Ttarg, alpha, ...
